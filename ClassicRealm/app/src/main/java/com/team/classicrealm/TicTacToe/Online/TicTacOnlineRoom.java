...
public class TicTacOnlineRoom extends AppCompatActivity {
        ...
        joinButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!networkUtil.isOnline()){
                    Toast.makeText(TicTacOnlineRoom.this, Prompts.NO_INTERNET, Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                if(!roomCode.isBlank()) {
                    ...
                    rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot snapshot) {
                            if(snapshot.exists()){
                                ...
                                if((event.getPlayerCount()==1)){
                                    joinRoom(roomCode);
                                    Intent intent = new Intent(TicTacOnlineRoom.this, TicTacOnline.class);
                                    ...
                                    Toast.makeText(TicTacOnlineRoom.this, Prompts.ENTER_VALID_CODE, Toast.LENGTH_SHORT).show();
                                }
                            }else{
                                Toast.makeText(TicTacOnlineRoom.this, Prompts.ENTER_VALID_CODE, Toast.LENGTH_SHORT).show();
                            }
                        ...
                        public void onCancelled(@NonNull DatabaseError error) {
                            Toast.makeText(TicTacOnlineRoom.this, error.toString(), Toast.LENGTH_SHORT).show();
                        }

                    });
                }else {
                    Toast.makeText(TicTacOnlineRoom.this, Prompts.ENTER_VALID_CODE, Toast.LENGTH_LONG).show();
                }
            }
        });
                ...
                rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot snapshot) {
                        if(snapshot.exists()){
                            ...
                            Intent intent = new Intent(TicTacOnlineRoom.this, TicTacOnlineWaitingRoom.class);
                            intent.putExtra(Constants.INTENT_KEY_ROOM_CODE_STRING,roomCode);
                            startActivity(intent);
                            finish();
                        }
