package com.team.classicrealm.Bounce;
...
public class BounceMenu extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_bounce_menu);
        ImageButton play=findViewById(R.id.bounceMenuPlayB);
        ImageButton bounceMenuBackb=findViewById(R.id.bounceMenuBackb);
        hideSystemUI();
